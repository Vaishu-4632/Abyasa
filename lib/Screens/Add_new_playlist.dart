...
//         meditationDownloadDuration = meditationDownloadData.map((item) => item['duration']).toList();
//       });
//     }
//   }
...
//               decoration: InputDecoration(border: InputBorder.none,hintText: "Add your playlist title",hintStyle: TextStyle(color: Colors.white54),),
...
//                                       //   setState(() {
//                                       //     asanaNames[index].isChecked = !asanaNames[index].isChecked;
//                                       //   });
//                                       // }, icon: Icon(asanaNames[index].isCheck ? Icons.check : Icons.add_circle_outline))
